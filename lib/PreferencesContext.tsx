...
const messages: Record<AppLanguage, Record<string, string>> = {
  en: {
    ...
    'dashboard.quickSettings': 'Quick settings', 'dashboard.useDayMode': 'Use day mode', 'dashboard.useNightMode': 'Use night mode',
    'profile.fallbackName': 'Friend', 'profile.title': 'What should we call you?', 'profile.help': 'Add your name for a more personal BoltShare experience. You can skip this and add it later in Settings.',
    'profile.firstName': 'First name', 'profile.lastName': 'Last name', 'profile.save': 'Save name', 'profile.skip': 'Skip for now',
    'profile.saving': 'Saving…', 'profile.saved': 'Your name has been saved', 'profile.saveError': 'Your name could not be saved. Please try again.',
    'profile.settingsTitle': 'Your name', 'profile.settingsHelp': 'This first name is used in your dashboard greeting.',
  ...
  fr: {
    ...
    'dashboard.quickSettings': 'Réglages rapides', 'dashboard.useDayMode': 'Utiliser le mode jour', 'dashboard.useNightMode': 'Utiliser le mode nuit',
    'profile.fallbackName': 'Ami', 'profile.title': 'Comment devons-nous vous appeler ?', 'profile.help': 'Ajoutez votre nom pour personnaliser BoltShare. Vous pouvez ignorer cette étape et le faire plus tard dans les paramètres.',
    'profile.firstName': 'Prénom', 'profile.lastName': 'Nom', 'profile.save': 'Enregistrer', 'profile.skip': 'Ignorer pour le moment',
    'profile.saving': 'Enregistrement…', 'profile.saved': 'Votre nom a été enregistré', 'profile.saveError': 'Votre nom n’a pas pu être enregistré. Réessayez.',
    'profile.settingsTitle': 'Votre nom', 'profile.settingsHelp': 'Ce prénom est utilisé dans l’accueil du tableau de bord.',
  ...
  es: {
    ...
    'dashboard.quickSettings': 'Ajustes rápidos', 'dashboard.useDayMode': 'Usar modo día', 'dashboard.useNightMode': 'Usar modo noche',
    'profile.fallbackName': 'Amigo', 'profile.title': '¿Cómo debemos llamarte?', 'profile.help': 'Añade tu nombre para personalizar BoltShare. Puedes omitirlo y añadirlo después en Configuración.',
    'profile.firstName': 'Nombre', 'profile.lastName': 'Apellido', 'profile.save': 'Guardar nombre', 'profile.skip': 'Omitir por ahora',
    'profile.saving': 'Guardando…', 'profile.saved': 'Tu nombre se ha guardado', 'profile.saveError': 'No se pudo guardar tu nombre. Inténtalo de nuevo.',
    'profile.settingsTitle': 'Tu nombre', 'profile.settingsHelp': 'Este nombre se utiliza en el saludo del panel.',
  ...
  pt: {
    ...
    'dashboard.quickSettings': 'Ajustes rápidos', 'dashboard.useDayMode': 'Usar modo diurno', 'dashboard.useNightMode': 'Usar modo noturno',
    'profile.fallbackName': 'Amigo', 'profile.title': 'Como devemos chamar você?', 'profile.help': 'Adicione seu nome para personalizar o BoltShare. Você pode pular e adicionar depois nas Configurações.',
    'profile.firstName': 'Nome', 'profile.lastName': 'Sobrenome', 'profile.save': 'Salvar nome', 'profile.skip': 'Pular por enquanto',
    'profile.saving': 'Salvando…', 'profile.saved': 'Seu nome foi salvo', 'profile.saveError': 'Não foi possível salvar seu nome. Tente novamente.',
    'profile.settingsTitle': 'Seu nome', 'profile.settingsHelp': 'Este nome é usado na saudação do painel.',
  ...
  zh: {
    ...
    'dashboard.quickSettings': '快捷设置', 'dashboard.useDayMode': '使用日间模式', 'dashboard.useNightMode': '使用夜间模式',
    'profile.fallbackName': '朋友', 'profile.title': '我们该如何称呼您？', 'profile.help': '添加您的姓名，让 BoltShare 更加个性化。您可以跳过并稍后在设置中添加。',
    'profile.firstName': '名字', 'profile.lastName': '姓氏', 'profile.save': '保存姓名', 'profile.skip': '暂时跳过',
    'profile.saving': '正在保存…', 'profile.saved': '您的姓名已保存', 'profile.saveError': '无法保存您的姓名，请重试。',
    'profile.settingsTitle': '您的姓名', 'profile.settingsHelp': '此名字将用于仪表盘问候语。',
  ...
  ar: {
    ...
    'dashboard.quickSettings': 'الإعدادات السريعة', 'dashboard.useDayMode': 'استخدام الوضع النهاري', 'dashboard.useNightMode': 'استخدام الوضع الليلي',
    'profile.fallbackName': 'صديقنا', 'profile.title': 'بماذا نناديك؟', 'profile.help': 'أضف اسمك لتجربة BoltShare أكثر تخصيصًا. يمكنك التخطي وإضافته لاحقًا من الإعدادات.',
    'profile.firstName': 'الاسم الأول', 'profile.lastName': 'اسم العائلة', 'profile.save': 'حفظ الاسم', 'profile.skip': 'التخطي الآن',
    'profile.saving': 'جارٍ الحفظ…', 'profile.saved': 'تم حفظ اسمك', 'profile.saveError': 'تعذر حفظ اسمك. حاول مرة أخرى.',
    'profile.settingsTitle': 'اسمك', 'profile.settingsHelp': 'يُستخدم هذا الاسم الأول في تحية لوحة التحكم.',
